    ...
    return (
        <TableContainer component={Paper} style={{ padding: "10px", margin: "20px" }}>
            <Flex style={{ justifyContent: "space-between" }}>
                <h2>
                    <b>League</b> : {props.leagueName}
                </h2>
                <Popup
                    trigger={<Button onClick={(i) => console.log(props.leagueCode)} style={{ float: "right;!important" }}>Invite friend</Button>}
                    modal
                    nested
                >
                    {close => (
                        <div className="modal">
                            ...
                            <div>
                                <br />
                                <button style={{ color: "#f00", padding: "7px" }} onClick={() => close()}>
                                    Close
                                </button>
                            </div>
                        </div>
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                <TableHead>
                    <TableRow>
                        ...
                        <StyledTableCell align="left">team name</StyledTableCell> {/* New Column Header for Team Name */}
